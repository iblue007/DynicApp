 ...
 */
public class MyDownCircleHdTipDialog extends Dialog {
    ...
    public MyDownCircleHdTipDialog(Context context) {
        super(context, R.style.Dialog_No_Anim);
        this.mContext =context;
        init();
    }

    public MyDownCircleHdTipDialog(Context context, int themeResId) {
        super(context, themeResId);
        this.mContext =context;
        init();
    }

    public MyDownCircleHdTipDialog(Context context, String title, String tip, String cancleStr, String okStr) {
        super(context, R.style.Dialog_No_Anim);
        this.mContext =context;
        this.title = title;
        this.tipStr = tip;
