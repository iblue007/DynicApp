...
/**一个圆形百分比进度 View
 * 用于展示简易的图标
 * Created by xuqunxing on 2018/4/3.
 */
...
//        得到所有自定义属性的数组
        ...
        progress = typedArray.getInteger(R.styleable.RoundProgress_progress,0);
//        不要忘记回收
        typedArray.recycle();
    }
...
//       1、 绘制圆环
        ...
        bigCirclePaint.setColor(ringColor);

        canvas.drawCircle(circleX, circleY, radius, bigCirclePaint);
...
//       2、 绘制圆弧
        ...
        canvas.drawArc(oval,-90, progress * 360 / max, false, paint);
//        3、绘制文本
