...
public class StatusBarUtil {
    ...
    private StatusBarUtil(int useBelowVersion, Window window, boolean lightStatusBar, boolean transparentStatusBar,
    ...
    public static class Builder {
        ...
        public void process() {
            ...
            new StatusBarUtil(useBelowVersion, window, lightStatusBar, transparentStatusBar
