...
import static com.felink.corelib.kitset.once.Amount.moreThan;
...
public class Once {
    ...
    public static final long TIME_HOUR = 60l * 60l * 1000l;
     ...
     */
    public static void toDo(int scope, String tag) {
     ...
     * <p>
     * Equivalent of calling {@code beenDone(int scope, String tag)} with scope of {@link #THIS_APP_INSTALL}.
     * </p>
     *
     * @param tag A string identifier unique to the operation.
     ...
     * <p>
     * Equivalent of calling {@code beenDone(int scope, String tag, CountChecker numberOfTimes)} with scope of {@link #THIS_APP_INSTALL} and a numberOfTimes of {@code Amount.moreThan(0)}.
     * </p>
     *
     * @param scope The scope in which to check whether the tag has been done, either
     *              {@link #THIS_APP_INSTALL} or {@link #THIS_APP_VERSION}.
     * @param tag   A string identifier unique to the operation.
     * @return {@code true} if the operation associated with {@code tag} has been marked done within
     ...
     */
    public static boolean beenDone(int scope, String tag, CountChecker numberOfTimes) {
